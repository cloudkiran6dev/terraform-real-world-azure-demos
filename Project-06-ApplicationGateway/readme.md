...
![Terraform CLI Installation](../Couse-images/Application_Gateway.png)

In this module, we will create **Azure Virtual Machine Scale Sets (VMSS)** using Terraform.

Until now, we created single Virtual Machines.  
But in real-world production environments, applications require:
...
To achieve this, Azure provides **Virtual Machine Scale Sets (VMSS)**.

In this module, we will:

- Create Azure Virtual Machine Scale Sets
- Associate VMSS with Azure Standard Load Balancer
- Implement Network Security Groups with inline rules
- Use Terraform Dynamic Blocks
...
The architecture in this module includes:
