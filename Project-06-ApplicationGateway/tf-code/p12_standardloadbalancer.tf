...
resource "azurerm_network_interface_backend_address_pool_association" "web_nic_lb_associate02" {
  network_interface_id = azurerm_network_interface.web_linuxvm_nic02.id 
  ip_configuration_name = azurerm_network_interface.web_linuxvm_nic02.ip_configuration[0].name
  backend_address_pool_id = azurerm_lb_backend_address_pool.web_lb_backend_address_pool.id   
}
*/
